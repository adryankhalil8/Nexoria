...
- Backend: Spring Boot 3.3, Spring Data JPA, Spring Security, PostgreSQL, JWT.
...
- Infrastructure: Docker Compose with Postgres, backend, frontend; CI with GitHub Actions.
